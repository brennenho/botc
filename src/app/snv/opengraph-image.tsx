...
export const alt = characterSheetSocialCards.snv.imageAlt;
export const size = socialCardSize;
export const contentType = socialCardContentType;

export default function SectsAndVioletsOpenGraphImage() {
  return createCharacterSheetSocialCardImage("snv");
}
