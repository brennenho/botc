...
export const alt = characterSheetSocialCards.tb.imageAlt;
export const size = socialCardSize;
export const contentType = socialCardContentType;

export default function TroubleBrewingOpenGraphImage() {
  return createCharacterSheetSocialCardImage("tb");
}
